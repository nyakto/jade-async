...
function parse(str, options){
  ...
  return {body: js, dependencies: parser.dependencies};
}
...
exports.compile = function(str, options){
  ...
  fn = new Function('locals, stream, jade', fn);
  var res = function(locals, stream) {
      return fn(locals, stream, Object.create(runtime));
  };
  if (options.client) {
